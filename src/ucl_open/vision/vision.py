...
class RandomFlip(BaseSchema):
    ...
    quad_time_lower_bound: float = Field(default=0.2, description="Lower bound (s) of the uniform distribution for quad flip timing.")
    quad_time_upper_bound: float = Field(default=0.5, description="Upper bound (s) of the uniform distribution for quad flip timing.")
